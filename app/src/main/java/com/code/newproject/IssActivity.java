...
public class IssActivity extends AppCompatActivity {
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		tt1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u1.putExtra("pdf", "https://drive.google.com/file/d/1iwsikSLseMIygOexSHzOyUn1lqE_wAYY/view?usp=drivesdk");
		...
		tt2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u2.putExtra("pdf", "https://drive.google.com/file/d/1x4ZwBXNdOrcrDB7Q1I1hHC57vYuq5udh/view?usp=drivesdk");
		...
		tt3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u3.putExtra("pdf", "https://drive.google.com/file/d/198gTfHBFAzRaSFKtFQ0clXkhFo4gPKWN/view?usp=drivesdk");
		...
		tt4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u4.putExtra("pdf", "https://drive.google.com/file/d/1Yvqzxdd_bworsJVvK08FWXZjEbonuRqV/view?usp=drivesdk");
		...
		tt5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u5.putExtra("pdf", "https://drive.google.com/file/d/1ndqZUyUP5r9NOrAGc7ipiNZ-KuDGpjl8/view?usp=sharing");
		...
		textview19.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				pp.putExtra("pdf", "https://drive.google.com/file/d/1q7GG0SR52i04zk5ZkeoJnlH1j_sEkKX2/view?usp=sharing");
	...
	private void initializeLogic() {
		setTitle("Information System Security");
		//btn color 
