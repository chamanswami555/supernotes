...
public class RtusemsActivity extends AppCompatActivity {
	...
	private Intent chr = new Intent();
	private Intent fiv = new Intent();
	private Intent six = new Intent();
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.rtusems);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		tt1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				one.setClass(getApplicationContext(), ComingActivity.class);
		...
		tt2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				two.setClass(getApplicationContext(), ComingActivity.class);
		...
		tt3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				ten.setClass(getApplicationContext(), Rtu3semActivity.class);
				ten.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(ten);
			}
		});
		...
		tt4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				chr.setClass(getApplicationContext(), RtuActivity.class);
				chr.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(chr);
			}
		});
		...
		tt5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				fiv.setClass(getApplicationContext(), Rtu5semActivity.class);
				fiv.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(fiv);
			}
		});
		...
		textview19.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				six.setClass(getApplicationContext(), ComingActivity.class);
				six.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(six);
			}
		});
	}
	...
	private void initializeLogic() {
		setTitle("Rajasthan Technical University");
