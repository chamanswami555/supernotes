...
public class PythonchapActivity extends AppCompatActivity {
	...
	private Intent pyu1 = new Intent();
	private Intent pyu2 = new Intent();
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.pythonchap);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		tt1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				pyu1.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				pyu1.putExtra("pdf", "https://drive.google.com/file/d/16alMBF7R7EJgkC6Q660eRfVpX7bvNwiT/view?usp=sharing");
				pyu1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(pyu1);
			}
		});
		...
		tt2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				pyu2.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				pyu2.putExtra("pdf", "https://drive.google.com/file/d/1fqYO1ZKzknrN3f37x6bn4TvWsrMUI4Gv/view?usp=sharing");
				pyu2.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(pyu2);
			}
		});
		...
		tt3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u3.putExtra("pdf", "https://drive.google.com/file/d/1oHywHxN_nBpwguzPajwldo3d0x9d283d/view?usp=sharing");
		...
		tt4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u4.putExtra("pdf", "https://drive.google.com/file/d/1Os8RQZCRF7BH39IazIHqaEWUGzDRLN9k/view?usp=sharing");
		...
		tt5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u5.putExtra("pdf", "https://drive.google.com/file/d/15sH13x43N64qwg4pejMicN7ft-29b8Dz/view?usp=sharing");
		...
		textview19.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				pp.putExtra("pdf", "https://drive.google.com/file/d/1rVhPpNbKtU3Yo4iQgc7l9F-u64oBEpHl/view?usp=sharing");
