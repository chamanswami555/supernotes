...
public class CnetActivity extends AppCompatActivity {
	...
	private Intent cnu1 = new Intent();
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		tt1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				cnu1.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				cnu1.putExtra("pdf", "https://drive.google.com/file/d/1TOP-Tuy-lL7ngFdEyraz421UlWb5vsMm/view?usp=sharing");
				cnu1.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(cnu1);
			}
		});
		...
		tt2.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u2.putExtra("pdf", "https://drive.google.com/file/d/1PFqdbZjJHQF6n70l0Dc4QzVJg_KbplZ8/view?usp=drivesdk");
		...
		tt3.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u3.putExtra("pdf", "https://drive.google.com/file/d/1ygMh8umK8m0pR63iSsCQhDiyEkz1M2Ac/view?usp=sharing");
		...
		tt4.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u4.putExtra("pdf", "https://drive.google.com/file/d/1-T-JFDtuf-jUQDt4-BsQNECY9iwvCA2i/view?usp=sharing");
		...
		tt5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				u5.putExtra("pdf", "https://drive.google.com/file/d/1GK2bcP1QOF0iBR_Qd04SU57B6t2DV1u9/view?usp=sharing");
		...
		textview19.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				...
				pp.putExtra("pdf", "https://drive.google.com/file/d/17XtW4KvFd6w2IzTvUjiv7XnwUE9n3KeP/view?usp=sharing");
