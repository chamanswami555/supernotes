...
public class RtuActivity extends AppCompatActivity {
	...
	private Intent dbms = new Intent();
	private Intent dccn = new Intent();
	private Intent dmm = new Intent();
	private Intent mi = new Intent();
	private Intent mefa = new Intent();
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		tt1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				dbms.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				dbms.putExtra("pdf", "https://drive.google.com/file/d/11Wh5EIosBvJ5kAbDquTOh4UMoPvGxaIR/view?usp=sharing");
				dbms.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(dbms);
			}
		});
		...
		tt2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				dccn.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				dccn.putExtra("pdf", "https://drive.google.com/file/d/1zksuti_mQJgxfDu_iysEsYbICI2v0EIT/view?usp=sharing");
				dccn.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(dccn);
			}
		});
		...
		tt3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				dmm.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				dmm.putExtra("pdf", "https://drive.google.com/file/d/11BT27iuE2NN-13uyi2Fz_jSDyLiQ0yMK/view?usp=sharing");
				dmm.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(dmm);
			}
		});
		...
		tt4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				mi.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				mi.putExtra("pdf", "https://drive.google.com/file/d/1AR22c55s4fbbIv_8OgFevON6-vQnxi5i/view?usp=sharing");
				mi.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(mi);
			}
		});
		...
		tt5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				mefa.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				mefa.putExtra("pdf", "https://drive.google.com/file/d/1tlW9h64P8WeqyGNZD-76MSCwsm-Oj_wb/view?usp=sharing");
				mefa.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(mefa);
			}
		});
		...
		textview19.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				toc.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				toc.putExtra("pdf", "https://drive.google.com/file/d/1KQ4F8rKNpqbzYJkPtZkF_1BxlHNRaZ-U/view?usp=sharing");
