...
public class Rtu3semActivity extends AppCompatActivity {
	...
	private Intent tc = new Intent();
	private Intent se = new Intent();
	private Intent oop = new Intent();
	private Intent dsa = new Intent();
	private Intent de = new Intent();
	private Intent aem = new Intent();
	
	@Override
	protected void onCreate(Bundle _savedInstanceState) {
		super.onCreate(_savedInstanceState);
		setContentView(R.layout.rtu3sem);
	...
	private void initialize(Bundle _savedInstanceState) {
		...
		tt1.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View _view) {
				tc.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				tc.putExtra("pdf", "https://drive.google.com/file/d/1PXd5qpwo87j5yHdhUA_XJI7TSak-btNZ/view?usp=sharing");
				tc.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(tc);
			}
		});
		...
		tt2.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				se.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				se.putExtra("pdf", "https://drive.google.com/file/d/1me2k9KoBWyqjbxIZq7zRD_1UjZb4M_Z5/view?usp=sharing");
		...
		tt3.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				oop.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				oop.putExtra("pdf", "https://drive.google.com/file/d/1mPrBcoDkHyuTUF2oTyT7_LiqBPmGQAd9/view?usp=sharing");
				oop.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(oop);
			}
		});
		...
		tt4.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				dsa.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				dsa.putExtra("pdf", "https://drive.google.com/file/d/1pH_LVEBLZbckavcpAgteKTW_9BZ-bbtV/view?usp=sharing");
				dsa.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(dsa);
			}
		});
		...
		tt5.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				de.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				de.putExtra("pdf", "https://drive.google.com/file/d/1bYA4c5tHDdKXBG13cIJgx-k0kvqH_-8K/view?usp=sharing");
		...
		textview19.setOnClickListener(new View.OnClickListener() {
			@Override
			public void onClick(View _view) {
				aem.setClass(getApplicationContext(), Pdfviewjavac1Activity.class);
				aem.putExtra("pdf", "https://drive.google.com/file/d/1SAqlI-eGA9rorDNowI24deYCYw7w-hjv/view?usp=sharing");
				aem.setFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
				startActivity(aem);
			}
		});
	}
